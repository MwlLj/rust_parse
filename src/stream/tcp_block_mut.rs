...
impl CStreamBlockParse {
    ...
    pub fn lines<F, T, L, LT>(&mut self, startLen: u64, t: &mut T, f: &mut F, lt: &mut LT, lf: &mut L) -> Result<(), &str>
        where F: FnMut(u64, Vec<u8>, &mut T) -> (bool, u64), L: FnMut(&mut T, &mut LT) -> bool {
